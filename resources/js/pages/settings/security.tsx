                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                yang bisa Anda dapatkan dari aplikasi pendukung TOTP di ponsel Anda.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                memasukkan PIN yang aman saat masuk. PIN ini dapat diambil dari 
                                aplikasi pendukung TOTP di ponsel Anda.
                            </p>
